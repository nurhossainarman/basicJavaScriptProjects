...
var ul = document.getElementById("dropdown-city"); // Fetching dropdown for DOM manipulation


cities.forEach(function(element){ //Adding cities in dropdownbox
  var listItem = document.createElement("li");
  var linkItem = document.createElement("a");
  linkItem.className= "dropdown-item";
  linkItem.href= "#";
  linkItem.dataset.value = element.timezone;
  linkItem.innerHTML= element.city;
